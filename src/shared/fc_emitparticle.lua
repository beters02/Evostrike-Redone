...
local Particles = game:GetService("ReplicatedStorage"):WaitForChild("Objects"):WaitForChild("Particles")
local module = {}
...
function module.GetBulletParticlesFromInstance(instance)
	...
	local folder = ReplicatedStorage.Objects.Particles.GunVisualEffects.Common.HitEffect:FindFirstChild(mat)
	if folder then
